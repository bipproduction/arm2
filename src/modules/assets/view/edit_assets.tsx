...
import ModalEditAssets from "../components/modal_edit_assets";


/**
 * Fungsi untuk menampilkan edit assets.
 * @returns {component} menampilakn edit assets.
 */
  ...
  return (
    <>
      <Stack>
        <ButtonBack />
        <Box>
          <Text fz={24} fw={"bold"} c={Warna.biruTua}>EDIT ASSETS</Text>
        </Box>
      </Stack>
      <Box pt={20}>
        <Box
